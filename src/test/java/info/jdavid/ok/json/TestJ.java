...
public class TestJ {
  ...
  public void testNumber1() {
    final Number n = J.stringToNumber("9");
  ...
  public void testNumber2() {
    final Number n = J.stringToNumber("-235");
    assertTrue(n instanceof Integer);
  ...
  public void testNumber3() {
    final Number n = J.stringToNumber("456.1");
  ...
  public void testNumber4() {
    final Number n = J.stringToNumber("-3.E-5");
    assertTrue(n instanceof Double);
  ...
  public void testNumber5() {
    final Number n = J.stringToNumber("1234567890123");
  ...
  public void testNumber6() {
    final Number n = J.stringToNumber("-12345678901");
    assertTrue(n instanceof Long);
  ...
  public void testNumber7() {
    final Number n = J.stringToNumber("-2147483649");
    assertTrue(n instanceof Long);
  ...
  public void testNumber8() {
    final Number n = J.stringToNumber("2147483647");
    assertTrue(n instanceof Integer);
  ...
  public void testNumber9() {
    final Number n = J.stringToNumber("-2000000000");
    assertTrue(n instanceof Integer);
  ...
  public void testNumber10() {
    final Number n = J.stringToNumber("-2800000000");
    assertTrue(n instanceof Long);
  ...
  public void testNumber11() {
    final Number n = J.stringToNumber("-1000000000");
    assertTrue(n instanceof Integer);
  ...
  public void testNumber12() {
    final Number n = J.stringToNumber("-3000000000");
    assertTrue(n instanceof Long);
  ...
  public void testParseEmpty() {
    final String str = "";
    final Object parsed = J.parse(str);
    assertNull(parsed);
  }
