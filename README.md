![jcenter](https://img.shields.io/badge/_jcenter_-_3.3.1-6688ff.png?style=flat) &#x2003; ![jcenter](https://img.shields.io/badge/_Tests_-_42/42-green.png?style=flat)
# okjson
...
[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/ok/json/okjson/3.3.1/okjson-3.3.1.jar) the latest jar.
...
```
dependencies {
  compile 'info.jdavid.ok.json:okjson:3.3.1'
}
```
