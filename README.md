![jcenter](https://img.shields.io/badge/_jcenter_-_3.7.0.1-6688ff.png?style=flat) &#x2003; ![jcenter](https://img.shields.io/badge/_Tests_-_59/59-green.png?style=flat) &#x2003; ![jcenter](https://img.shields.io/badge/_Coverage_-_78%25-blue.png?style=flat)
# okjson
...
[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/ok/json/okjson/3.7.0.1/okjson-3.7.0.1.jar) the latest jar.
...
```
dependencies {
  compile 'info.jdavid.ok.json:okjson:3.7.0.1'
}
```
